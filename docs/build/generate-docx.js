...
children.push(bullet("Título y descripción SIEMPRE por aparte (regla desde el 18 ago 2026): el título del commit debe ser corto (máx. 72 caracteres) — si es más largo, GitHub lo trunca al autollenar el PR y arrastra el resto al campo de título, dejándolo incompleto y mezclado con la descripción. Al abrir el PR, verificar que el campo Title tenga solo la línea del título y que las viñetas queden en el campo Description; si el autollenado los mezcló, separarlos a mano."));
