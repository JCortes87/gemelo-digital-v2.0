...
children.push(bullet("Reubicación del consumo de contenidos (3 ago): el bloque completo (barras 'Promedio de acceso a contenidos' y 'X de Y estudiantes han abierto elementos' + desplegable 'Acceso a contenidos' con el detalle por estudiante) se movió de la tarjeta 'Accesos al curso' a la tarjeta KPI 'Elementos publicados', para que publicación y consumo se lean juntos: total publicado, tipos de elemento y debajo cuánto acceden los estudiantes."));
