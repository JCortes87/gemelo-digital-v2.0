...
children.push(bullet("Reubicación del consumo de contenidos (3 ago): las barras de resumen ('Promedio de acceso a elementos publicados' y 'X de Y estudiantes han abierto elementos') se movieron de la tarjeta 'Accesos al curso' a la tarjeta KPI 'Elementos publicados', para que publicación y consumo se lean juntos; el desplegable 'Acceso a contenidos' (detalle por estudiante y elementos abiertos) se quedó en 'Accesos al curso'."));
