...
export default function EvidenceReports({
  ...
  const samples = useMemo(() => {
    ...
    const mid = loaded.filter(
      (s) => s.currentPerformancePct >= 60 && s.currentPerformancePct < 85,
    );
  ...
  useEffect(() => {
    ...
    targets.forEach(async (s) => {
      ...
      try {
        const data = await apiGet(
          `/gemelo/course/${orgUnitId}/student/${s.userId}`,
        );
    ...
    return (
      ...
      >
        ...
        <div style={{ fontSize: 11, marginTop: 4 }}>
          Se necesitan estudiantes con notas calificadas.
        </div>
      </div>
    );
  }
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 10, color: "var(--muted)", marginTop: 2 }}>
              ID {student.userId} · Cobertura:{" "}
              {student.coveragePct != null
                ? `${student.coveragePct.toFixed(0)}%`
                : "—"}
            </div>
          </div>
          ...
          {detail.loading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              {evidences.slice(0, 6).map((e, i) => {
                ...
                const evColor = isGraded
                  ? colorForPct(e.scorePct, null)
                  : "var(--muted)";
    ...
    <div>
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 11, color: "var(--muted)", marginTop: 2 }}>
            Selección aleatoria de un estudiante por banda de desempeño con sus
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 14 }}>
        ...
        {renderSample({
          ...
          icon: "",
          description:
            "Estudiante con desempeño bajo (< 6.0/10) — requiere atención",
      ...
      >
        Estos informes son útiles para reuniones de coordinación o revisiones de
        calidad. Haz clic en un estudiante para abrir su gemelo digital
        completo. Usa para descargar el trabajo y para ver la retroalimentación
        del docente.
      </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                ...
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #0B2D5C 0%, #0B5FFF 100%)",
                    ...
                    padding: "6px 10px",
                    cursor:
                      feedbackModal.loading || !feedbackModal.data
                        ? "not-allowed"
                        : "pointer",
                    opacity:
                      feedbackModal.loading || !feedbackModal.data ? 0.5 : 1,
                    fontFamily: "var(--font)",
                  }}
                >
                  {" "}
            ...
            <div
              ...
              style={{ padding: "16px 18px 0", borderBottom: "2px solid #000" }}
            >
              <div
                style={{
                  fontSize: 10,
              ...
              <div
                style={{ fontSize: 16, fontWeight: 800, margin: "4px 0 2px" }}
              >
                {feedbackModal.evidenceName}
              </div>
              <div style={{ fontSize: 12, color: "#555" }}>
                Estudiante: {feedbackModal.studentName} · Fecha:{" "}
                ...
                (() => {
                  ...
                  const levelColor = (level) => {
                    ...
                    if (
                      l.includes("interm") ||
                      l.includes("satisf") ||
                      l.includes("aceptable") ||
                      l.includes("proficien")
                    )
                      return "var(--brand)";
                    if (
                      l.includes("basi") ||
                      l.includes("elemental") ||
                      l.includes("suficiente") ||
                      l.includes("developing")
                    )
                      return "#d97706";
                    if (
                      l.includes("inicial") ||
                      l.includes("no cumple") ||
                      l.includes("deficiente") ||
                      l.includes("insuficiente") ||
                      l.includes("beginning")
                    )
                      return "var(--critical)";
                    return "var(--muted)";
                  };
                      ...
                      {(score != null || outOf != null) && (
                        <div
                          style={{
                            ...
                            borderRadius: 12,
                            background:
                              "linear-gradient(135deg, var(--brand-light) 0%, rgba(255,255,255,0) 100%)",
                            border: "1px solid var(--brand-light2, #D6E4FF)",
                            display: "flex",
                            alignItems: "center",
                            gap: 14,
                            ...
                            {score != null && outOf != null && (
                              ...
                              >
                                <div
                                  style={{
                                    height: "100%",
                                    width: `${Math.min(100, (score / outOf) * 100)}%`,
                            ...
                            >
                              ...
                              {r.score != null && (
                                ...
                                >
                                  ...
                                  {(() => {
                                    const computedLevel =
                                      levelFromPct(r.score, r.outOf) || r.level;
                                    return computedLevel ? (
                                      <div
                                        style={{
                                          ...
                                          background:
                                            levelColor(computedLevel) + "18",
                                          color: levelColor(computedLevel),
                                          border:
                                            "1px solid " +
                                            levelColor(computedLevel) +
                                            "40",
                                        }}
                                      >
                                        {computedLevel}
                                  ...
                                  {r.score != null && r.outOf != null && (
                                    ...
                                    >
                                      <div
                                        style={{
                                          height: "100%",
                                          width: `${Math.min(100, (r.score / r.outOf) * 100)}%`,
                                          background:
                                            levelColor(r.level) ||
                                            "var(--brand)",
                                          borderRadius: 99,
