...
function GradePredictions({
  ...
  if (total === 0) {
    return (
      <div className="empty-v2" style={{ padding: "24px 20px" }}>
        ...
        >
          Sin datos suficientes para predecir notas finales
        </div>
    ...
    >
      ...
      <div
        style={{
          ...
          gap: 5,
          maxHeight: variant === "full" ? 360 : 200,
          overflowY: "auto",
        }}
      >
          ...
          return (
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  Nota actual:{" "}
                  {student.currentPerformancePct != null
                    ? (student.currentPerformancePct / 10).toFixed(1)
                    : "—"}
                  /10
                  {" · "}Cobertura:{" "}
    ...
    <div>
            ...
            <div>
              ...
              >
                ...
                <span style={{ fontWeight: 700, color: "var(--brand)" }}>
                  {progressPct.toFixed(0)}% completado
                </span>
        ...
        {showHelp && (
          ...
          >
            <p style={{ margin: "0 0 8px" }}>
              La predicción <strong>NO usa machine learning</strong>. Es una
              proyección determinística simple:
            </p>
            <div
              style={{
                background: "var(--card)",
            ...
            >
              <div>
                • Tomamos la nota actual del estudiante (sobre el % calificado
                del curso).
              </div>
              <div>
                • Asumimos que mantendrá ese mismo desempeño en el % restante.
              </div>
              <div>• La nota proyectada = nota actual.</div>
            </div>
            <p style={{ margin: "0 0 8px" }}>
              La <strong>confianza</strong> crece con la cobertura calificada:
              si solo se ha calificado el 20% del curso, la proyección es muy
              especulativa (confianza 20%). Si está en 80%, la proyección es muy
              fiable.
            </p>
            <p
              style={{ margin: 0, fontStyle: "italic", color: "var(--muted)" }}
            >
              Categorías:&nbsp;
              <span style={{ color: COLORS.critical, fontWeight: 700 }}>
                Reprobará (&lt;5.0)
              </span>{" "}
              ·{" "}
              <span style={{ color: COLORS.watch, fontWeight: 700 }}>
                En el límite (5.0–5.9)
              </span>{" "}
              ·{" "}
      ...
      {willFail.length > 0 && (
        <StudentList
          ...
          label="Alto riesgo de reprobación"
          Icon={AlertTriangle}
        />
      )}
