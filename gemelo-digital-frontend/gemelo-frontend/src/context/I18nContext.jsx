...
const translations = {
  es: {
    ...
    "dashboard.gradeDistribution": "Distribución de calificaciones",
    ...
    "nav.predictions": "Predicción de calificaciones",
    ...
    "topbar.coordination": "Panel de coordinación",
    "topbar.language": "Idioma",
    "topbar.lightMode": "Tema claro",
  ...
  en: {
    ...
    "topbar.coordination": "Coordination panel",
    "topbar.language": "Language",
    "topbar.lightMode": "Light theme",
    "topbar.darkMode": "Dark theme",
    "topbar.print": "Print view",
